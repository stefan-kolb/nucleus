...
describe Paasal::Adapters::V1::CloudControl do
  before :all do
    ...
    @app_min = { original_name: 'paasaltestappminproperties66',
                         updated_name: 'paasaltestappminproperties66',
                         region: 'default' }
    @app_all = { original_name: 'paasaltestappallproperties66',
                         updated_name: 'paasaltestappallproperties66',
                         region: 'default' }
