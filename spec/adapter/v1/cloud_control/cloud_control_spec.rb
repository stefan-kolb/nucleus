...
describe Paasal::Adapters::V1::CloudControl do
  before :all do
    ...
    @app_min = { original_name: 'paasaltestappminproperties62',
                         updated_name: 'paasaltestappminproperties62',
                         region: 'default' }
    @app_all = { original_name: 'paasaltestappallproperties62',
                         updated_name: 'paasaltestappallproperties62',
                         region: 'default' }
