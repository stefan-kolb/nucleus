...
describe Paasal::Adapters::V1::CloudControl do
  before :all do
    ...
    @app_min = { original_name: 'paasaltestappminproperties69',
                         updated_name: 'paasaltestappminproperties69',
                         region: 'default' }
    @app_all = { original_name: 'paasaltestappallproperties69',
                         updated_name: 'paasaltestappallproperties69',
                         region: 'default' }
